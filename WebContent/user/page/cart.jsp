...
//			var num=$(this).parent().parent().siblings('.num').children('input').val();
  ...
  console.log(str);
  if(str.length>0){
     var url = '../page/CartToOrderServlet?itemIds='+str;//'cartToOrder.action?itemIds='+str;
...
$(function(){
    ...
    $(".add").each(function() {
      $(this).click(function() {
        ...
        $.ajax({
          type: "GET",
          url: "/xzsc/user/page/ChangeItemNumServlet",
    ...
    $('.del_d').click(function() {
        ...
        $('.yes').click(function(){
          var url ='DeleteCartItemServlet?itemId='+id;
           window.location.href=url;
        })
    });
});
