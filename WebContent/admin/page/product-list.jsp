                ...
                <div class="box box-primary">
                  <div class="box-body">
                    <table id="my_order" class="table table-bordered table-striped">
                      ...
                      <tbody>
                      <%
    					ArrayList<Book> books = (ArrayList<Book>)request.getAttribute("allbooks");
                      ...
                      <tr>
                        ...
                        <td><a href="product-detail?isbn=<%=book.getIsbn() %>">查看</a>丨<a href="product-edit?isbn=<%=book.getIsbn() %>">编辑</a></td>
                      </tr>
                      <%
      }
      %>
